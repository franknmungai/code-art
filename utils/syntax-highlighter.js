function w3CodeColor(elmntTxt, lang = 'html') {
  //   var elmntObj = document.getElementById(elmnt) || elmnt;
  //   var elmntTxt = elmntObj.innerHTML;
  var tagcolor = '#ccc';
  var tagnamecolor = '#F03B72';
  var attributecolor = '#CC8557';
  var attributevaluecolor = '#98BE5E';
  var commentcolor = 'green';
  var cssselectorcolor = '#EC6866'; // '#D1905F';
  var csspropertycolor = '#ABB2BF';
  var csspropertyvaluecolor = '#D18D55';
  var cssdelimitercolor = '#FFC225'; //'ABB2BF';
  var cssimportantcolor = 'crimson';
  var jscolor = 'black';
  var jskeywordcolor = '#8962DD';
  var jsstringcolor = '#89953F';
  var jsnumbercolor = '#D17C44';
  var jspropertycolor = '#ABB2BF';
  // elmntObj.style.fontFamily = "Consolas,'Courier New', monospace";

  if (lang.includes('html')) {
    // elmntTxt = htmlMode(elmntTxt);
    return htmlMode(elmntTxt);
  }
  if (lang.includes('css')) {
    // elmntTxt = cssMode(elmntTxt);
    return cssMode(elmntTxt);
  }
  if (lang.includes('js')) {
    // elmntTxt = jsMode(elmntTxt);
    return jsMode(elmntTxt);
  }
  ...
  function htmlMode(txt) {
    try {
      ...
      console.log('HTML Highlighting error ', error);
    }
  }
  ...
  function cssMode(txt) {
    try {
      ...
      console.log('CSS Highlighting error', error);
    }
  }
  ...
  function jsMode(txt) {
    try {
      ...
      console.log('JS Highlighting error ' + error);
    }
  }
